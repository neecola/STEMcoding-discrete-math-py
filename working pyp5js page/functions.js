...
`
/*
    if keyWasPressed and not keyIsPressed:
        if doesxychecker1exist == 1:
            if keyWas == 1 and ychecker1 > ychecker1old: checker1canmove = 1
            if keyWas == 1 and ychecker1 == ychecker1old and checker1stopsatbottom != 1: checker1canmove = 0

        if doesxychecker2exist == 1:
            if keyWas == 2 and ychecker2 > ychecker2old: checker2canmove = 1
            if keyWas == 2 and ychecker2 == ychecker2old and checker2stopsatbottom != 1: checker2canmove = 0

        if doesxychecker3exist == 1:
            if keyWas == 3 and ychecker3 > ychecker3old: checker3canmove = 1
            if keyWas == 3 and ychecker3 == ychecker3old and checker3stopsatbottom != 1: checker3canmove = 0

        if doesxychecker4exist == 1:
            if keyWas == 4 and ychecker4 > ychecker4old: checker4canmove = 1
            if keyWas == 4 and ychecker4 == ychecker4old and checker4stopsatbottom != 1: checker4canmove = 0
...
`;
*/
let userCode = sketchCode.concat(functionsCode);
